...
namespace Expanding_media_library
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Song song = new Song("Esterday", "Yesterday it seemed that all the problems were far away, but now the girl left for some unknown reason and where, and everything became completely different. It came so suddenly yesterday.How I would like to return yesterday to change everything", "Beatels", 58, "Help!");
